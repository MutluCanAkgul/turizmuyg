...
class YanPageeng11 extends StatefulWidget{
  @override
  State<StatefulWidget> createState()=> _YanPage();


}
class _YanPage extends State<YanPageeng11>{
  @override
     ...
     body: Container(
      ...
      width: double.maxFinite,height: 270,decoration: BoxDecoration(
       ...
       decoration: BoxDecoration(color: const Color.fromARGB(255, 255, 255, 255),borderRadius: BorderRadius.only(topLeft: Radius.circular(30),topRight: Radius.circular(30))),child: Column(
        ...
        children: [ Text("Çesme Spas",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w400,color: Colors.lightBlue),)// buton eklenebilir duruma göre
        ...
        ),SizedBox(height: 3,),Column(children: [Text("Among the Çeşme Thermal Springs, there are Şifne and Ilıca thermal springs. Among these two groups, Şifne Hot Springs is located in Şifne Bay, which is located in the north of Çeşme peninsula. It is possible to reach the hot springs easily by reaching Çeşme after an 80 km road from İzmir city center. The thermal water features of these spas are 42 and 49 degrees, clear, sodium chloride and calcium. The waters of Şifne Hot Springs are also known to be good for rheumatism, gynecological diseases, urinary tract disorders, stomach and intestinal disorders, rickets and skin disorders such as eczema or psoriasis. There are also many accommodation facilities, restaurants and cafe services here.")],)],
       ),

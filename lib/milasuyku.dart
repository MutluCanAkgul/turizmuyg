...
class YanPage18 extends StatefulWidget{
  @override
  State<StatefulWidget> createState()=> _YanPage();


}
class _YanPage extends State<YanPage18>{
  @override
     ...
     body: Container(
      ...
      width: double.maxFinite,height: 270,decoration: BoxDecoration(
       ...
       decoration: BoxDecoration(color: const Color.fromARGB(255, 255, 255, 255),borderRadius: BorderRadius.only(topLeft: Radius.circular(30),topRight: Radius.circular(30))),child: Column(
        ...
        children: [ Text("Milas Uyku Vadisi",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w400,color: Colors.lightBlue),)// buton eklenebilir duruma göre
        ...
        ),SizedBox(height: 3,),Column(children: [Text("Uyku Vadisi Turistik Tesisleri, Bodrum Milas Havalimanı’nın batısında (11 km), en yakın yerleşim bölgesi olan Gökçeler Köyü’ne 800 metre mesafede, Hamza Bey Çayı’nın kıyısında, zeytin, çam, çınar, ceviz ve narenciye ağaçlarının içinde konaklarama ve restaurant hizmeti vermektedir.Dört mevsimin bütün özelliklerini yaşayabileceğiniz doğal çevrede mevsimine göre; şırıl şırıl akan suyun sesinin, kuşların cıvıltılarının, şöminede yanan odunların çıtırtısının zevkine varabilirsiniz.")],)],
       ),
